...
export const data = [

    {
        ...
        id: 1,
        image: "/assets/Pantry_Tracker.png",
        title: "Pantry Tracker",
        text: `Pantry Tracker is a web application that helps users keep track of their pantry items, including food, beverages, and other household items. Users can add, update, and delete items from their pantry, as well as view details about each item. The app also integrate an AI feature, which recommend recipe for the user specific item.`,
        technologies: ['Next.js', 'Firebase', 'OpenAI API', 'Google Auth', "Jotai", 'Material-UI', 'Rest APIs', "Tailwind CSS"],
        webUrl: 'https://pantry-tracker-eight-xi.vercel.app',
        githubUrl: 'https://github.com/Festus-Osayi/Assets/tree/master/inventory-management',
        category: 'Fullstack Development',
    },

    {
        id: 2,
        image: "/assets/Customer_support.png",
        title: "AI Customer Support",
        text: `A friendly customer support chatbot .Which incorporate some of your favorite celebrity to make the experience more engaging and enjoyable. The chatbot is designed to provide users with quick and accurate responses to their questions, as well as personalized recommendations and assistance.`,
        technologies: ['Next.js', 'Firebase', 'OpenAI API', 'Tailwind CSS', 'TMDB API', 'Rest APIs', 'Material-UI'],
        webUrl: 'https://fusiontalk-ai.vercel.app/',
        githubUrl: 'https://github.com/Festus-Osayi/Assets/tree/master/AI-Customersupport',
        category: "Fullstack Development"
    },

    {
        id: 3,
        image: "/assets/AI_Flashcards.png",
        title: "AI Flashcards",
        text: `AI Flashcards is a web application that helps users study and memorize information using flashcards. The app leverages AI technology to generate flashcards based on user input, making it easy to create custom study materials. Users can create, edit, and delete flashcards, as well as test their knowledge with interactive quizzes.`,
        technologies: ['Next.js', 'Clerk.js', 'Firebase', 'OpenAI API', 'Tailwind CSS', 'Rest APIs', 'Material-UI', "Stripe.js"],
        githubUrl: 'https://github.com/Festus-Osayi/Assets/tree/master/AI-FlashCards',
        category: 'Fullstack Development',
    },
    ...
    ,
    {
        ...
        id: 4,
        image: "/assets/metropolitan museum.jpg",
    ...
    },
    {
        ...
        id: 5,
        image: "/assets/ecommerce-front.jpg",
...
export const technicalSkills = [
    {
        id: 1,
        skillName: ['JavaScript', 'Node', 'Express'],
        skillPercent: '94%',
        skillProficiency: 'Great'
    ...
    {
        id: 3,
        skillName: ['React', 'NextJS', 'Tailwind'],
        skillPercent: '88%',
        skillProficiency: 'Superb'

    },

    {
        id: 4,
        skillName: ["Java", "Spring Boot", 'Python', 'Flask', 'C', 'C++'],
        skillPercent: '90%',
    ...
    {
        id: 5,
        skillName: ['Oracle', 'PostgreSQL', 'MongoDB'],
        skillPercent: '85%',
        skillProficiency: 'Brilliant'

    },

    {
        id: 6,
        skillName: ['Github', 'Bitbucket', 'Jira'],
        skillPercent: '90%',
    ...
    {
        id: 8,
        skillName: ['Jenkins', 'Docker', "Kubernetes", "CI/CD", "Maven"],
        skillPercent: '90%',
        skillProficiency: 'Excellent'
...
/** Who I am */
export const texts = ["Fullstack Developer", "Coder", "Web Developer", "API Designer", "Cloud Enthusiastic", "Problem Solver", "Nap Champion", "Code Debugger", "Git Push or Ghost", "Vibe Checker"]